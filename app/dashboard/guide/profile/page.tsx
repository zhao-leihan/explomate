...
export default function GuideProfilePage() {
  ...
  const handleStartVerification = async () => {
    ...
    try {
      ...
      const isFail = idCardNumber.toLowerCase().includes("fail");
      const newStatus = isFail ? "REJECTED" : "APPROVED";
      const rejectReason = isFail ? "Photograph of ID Card is too dark or number did not match governmental registry." : null;
