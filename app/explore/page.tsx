...
import { Search, SlidersHorizontal, Grid, Map, X, ChevronLeft, ChevronRight } from "lucide-react";
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          ...
          <form onSubmit={handleSearch} className="flex gap-3 mb-6">
            ...
            <button
              ...
              className="border-2 border-white/20 text-white hover:bg-white/10 px-4 rounded-xl flex items-center gap-2 transition-colors font-medium text-sm"
            >
          ...
          {/* Categories */}
          <div className="relative flex items-center group/nav mb-6">
            {/* Left Scroll Button */}
            <button
              type="button"
              onClick={() => scrollCategories("left")}
              className="absolute left-0 z-10 p-1.5 rounded-full bg-dark-900/90 border border-dark-800 shadow-md text-white hover:bg-primary hover:text-white transition-all opacity-0 group-hover/nav:opacity-100 focus:opacity-100 -translate-x-2 backdrop-blur-sm"
            ...
            <button
              ...
              className="absolute right-0 z-10 p-1.5 rounded-full bg-dark-900/90 border border-dark-800 shadow-md text-white hover:bg-primary hover:text-white transition-all opacity-0 group-hover/nav:opacity-100 focus:opacity-100 translate-x-2 backdrop-blur-sm"
          ...
          {/* Expanded Filters */}
          {showFilters && (
            <div className="mt-4 p-4 bg-dark-900 rounded-xl border border-dark-800/60 grid grid-cols-1 sm:grid-cols-4 gap-4">
              <div>
